<template>
    <footer class="bg-white">
      <div class="mx-auto max-w-7xl px-6 py-20 sm:py-24 lg:px-8">
        ...
        <!-- Línea inferior -->
        <div class="mt-16 flex flex-col md:flex-row items-center justify-between border-t pt-6">
          <p class="text-sm text-gray-600">© 2024 Constructora Santa Emma SpA. Todos los derechos reservados.</p>
          <div class="mt-4 md:mt-0 flex space-x-6">
            <a href="#" class="text-gray-600 hover:text-gray-800" aria-label="Facebook">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/>
              </svg>
            </a>
            <a href="#" class="text-gray-600 hover:text-gray-800" aria-label="Instagram">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#" class="text-gray-600 hover:text-gray-800" aria-label="Twitter / X">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
