<template>
    <footer class="bg-[#1c120a] text-white font-semibold">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div class="flex flex-col items-center text-center">
            ...
            <div class="mt-8 text-sm">
              <h3 class="font-bold uppercase text-white">Ubicación</h3>
            ...
            <div class="mt-8 flex flex-col sm:flex-row sm:justify-center sm:space-x-16 text-sm text-left sm:text-center">
              <!-- Teléfono -->
              <div>
                <h3 class="font-bold uppercase text-white text-center">Teléfono</h3>
              ...
              <!-- Correo -->
              <div>
                <h3 class="font-bold uppercase text-white text-center mt-8 sm:mt-0">Correo</h3>
  ...
  ></iframe>
        ...
        <div class="mt-16 flex flex-col md:flex-row items-center justify-between border-t border-gray-700 pt-6">
          ...
          <div class="mt-4 md:mt-0 flex space-x-6">
            ...
            <a href="#" class="text-white hover:text-yellow-400 transition-colors" aria-label="Twitter / X">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
