<template>
    <section class="relative isolate bg-gray-900 min-h-[80vh] flex items-end sm:items-center py-16 sm:py-0">
  ...
  <style scoped>
  /* Nada extra. Mínimo necesario para asegurar que el fondo funcione fijo */
  </style>
