<template>
    <section
      class="relative isolate overflow-hidden bg-gray-900 min-h-[80vh] flex flex-col sm:flex-row sm:items-center sm:justify-center pt-24 sm:pt-0"
    >
      <!-- Imagen de fondo -->
      <div
      ...
      <!-- Contenido -->
      <div
        class="relative z-10 w-full max-w-4xl px-6 lg:px-20 text-center sm:text-left animate-contentFade"
      >
        ...
        <p
          v-if="subtitle"
          class="mt-4 text-lg sm:text-xl text-white leading-snug max-w-2xl mx-auto sm:mx-0"
        >
          {{ subtitle }}
        </p>
