<template>
    <footer class="bg-white text-gray-800 font-semibold">
      <div class="mx-auto max-w-7xl px-6 py-20 sm:py-24 lg:px-8">
            ...
            <div class="mt-8 flex flex-col sm:flex-row sm:justify-center sm:space-x-16 text-sm text-left sm:text-center">
              ...
              <div>
                ...
                <p class="mt-4 text-center">
                  📧 <a href="mailto:contacto@santaemma.cl" class="hover:underline text-gray-800 font-semibold">contacto@santaemma.cl</a>
                </p>
                <p class="text-center">
                  📨 <a href="mailto:quejas@santaemma.cl" class="hover:underline text-gray-800 font-semibold">quejas@santaemma.cl</a>
                </p>
              </div>
            </div>
          </div>
        ...
        <!-- Línea inferior -->
        <div class="mt-16 flex flex-col md:flex-row items-center justify-between border-t border-gray-300 pt-6">
          <p class="text-sm text-gray-700 font-semibold">© 2024 Inversiones Santa Emma SpA. Todos los derechos reservados.</p>
          <div class="mt-4 md:mt-0 flex space-x-6">
            <a href="#" class="text-gray-800 hover:text-yellow-600 transition-colors" aria-label="Facebook">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
              </svg>
            </a>
            <a href="#" class="text-gray-800 hover:text-yellow-600 transition-colors" aria-label="Instagram">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M7.75 2A5.75 5.75 0 002 7.75v8.5A5.75 5.75 0 007.75 22h8.5A5.75 5.75 0 0022 16.25v-8.5A5.75 5.75 0 0016.25 2h-8.5zm0 1.5h8.5A4.25 4.25 0 0120.5 7.75v8.5a4.25 4.25 0 01-4.25 4.25h-8.5a4.25 4.25 0 01-4.25-4.25v-8.5A4.25 4.25 0 017.75 3.5zm8.25 2.75a.75.75 0 100 1.5.75.75 0 000-1.5zM12 7.25a4.75 4.75 0 100 9.5 4.75 4.75 0 000-9.5zm0 1.5a3.25 3.25 0 110 6.5 3.25 3.25 0 010-6.5z" />
              </svg>
            </a>
            <a href="#" class="text-gray-800 hover:text-yellow-600 transition-colors" aria-label="Twitter / X">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  const onMapLoad = () => {
    console.log('Mapa blanco cargado')
  }
  </script>
